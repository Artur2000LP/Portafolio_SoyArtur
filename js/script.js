...
function mostrarImgCertificados() {
	...
	imgs.forEach(img => {
		img.addEventListener("click", () => {
			...
			if (img.classList.contains('rotatable')) {
				overlayImg.classList.add('rotated');
			} else {
				overlayImg.classList.remove('rotated');
			}
		});
	});
